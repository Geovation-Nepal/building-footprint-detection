...
Train_Image_Dir="C:/Msc/Thesis/Work done/augumentation/Massachutt/Training data/training_image_crop/" # Images and labels for training
Train_Label_Dir="C:/Msc/Thesis/Work done/augumentation/Massachutt/Training data/target _map_crop/"# Annotetion in png format for train images and validation images (assume the name of the images and annotation images are the same (but annotation is always png format))
UseValidationSet=False# do you want to use validation set in training
Valid_Image_Dir="C:/Users/Sanjeevan Shrestha/Desktop/semantic segmentation/Materials_In_Vessels/Test_Images_All/"# Validation images that will be used to evaluate training
Valid_Labels_Dir="C:/Users/Sanjeevan Shrestha/Desktop/semantic segmentation/Materials_In_Vessels/LiquidSolidLabels/"#  (the  Labels are in same folder as the training set)
...
learning_rate=1e-1 #Learning rate for Adam Optimizer
...
TrainaccuracyTxtFile=logs_dir+"TrainAccuracy.txt"
ValidaccuracyTxtFile=logs_dir+"ValidationAccuracy.txt"
Batch_Size=2 # Number of files per training iteration
Weight_Loss_Rate=5e-6# Weight for the weight decay loss function
...
#...................................... Get accuracy function for neural network one accuracy function for each set of Label
    correct_prediction = tf.equal(Net.Pred, tf.argmax(GTLabel.squeeze())
...
#......................Write and display train loss..........................................................................
        if itr % 10==0:
            ...
            TLoss, Taccuracy =sess.run([Loss,accuracy], feed_dict=feed_dict)
            print("Step "+str(itr)+" Train Loss="+str(TLoss)+ "Train accuracy="+str(Taccuracy))
            #Write train loss to file
            with open(TrainLossTxtFile, "a") as f1, open(TrainaccuracyTxtFile, "a") as f2:
                f1.write("\n"+str(itr)+"\t"+str(TLoss))
...
#......................Write and display Validation Set Loss by running loss on all validation images.....................................................................
        if UseValidationSet and itr % 2000 == 0:
            ...
            for i in range(NBatches):# Go over all validation image
                ...
                TLoss, Taccuracy = sess.run([Loss,accuracy], feed_dict=feed_dict)
                SumLoss+=TLoss
                SumAccuracy+=Taccuracy
                NBatches+=1
            SumLoss/=NBatches
            SumAccuracy/=NBatches
            print("Validation Loss: "+str(SumLoss)+ "Validation Accuracy: "+str(SumAccuracy))
            with open(ValidLossTxtFile, "a") as f1, open(ValidaccuracyTxtFile, "a") as f2:
                f1.write("\n" + str(itr) + "\t" + str(SumLoss))
